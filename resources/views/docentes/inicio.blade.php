    ...
    <div class="d-flex">
        ...
        <nav class="bg-dark text-white vh-100 p-3" style="width: 250px;">
            <h4 class="text-center">
                <a href=" {{ route('docentes.inicio', ['id' => $docente->id]) }} " class="text-white text-decoration-none">Campus Virtual</a>
            </h4>
        ...
        <div class="flex-grow-1">
            ...
            <header class="bg-primary text-white py-3 px-4">
                <h1 class="m-0">
                    <a href=" {{ route('docentes.inicio', ['id' => $docente->id]) }} " class="text-white">Campus Virtual</a>
                </h1>
            </header>
                ...
                @forelse ($cursos as $curso)
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <a href=" {{ route('docentes.curso', ['id' => $docente->id, 'curso_id' => $curso->id]) }} " class="btn btn-primary">Ver Curso</a>
                        </div>
                    </div>
                @empty
